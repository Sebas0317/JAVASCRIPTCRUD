...
function AddData() {
    ...
    const Toast = Swal.mixin({
      ...
      Toast.fire({
        icon: 'success',
        title: 'Los datos han sido actualizados satisfactoriamente'
      })
}
...
function EditData(index) {
    ...
    Toast.fire({
    icon: 'success',
    title: 'Los datos han sido recogidos satisfactoriamente'
    })
...
function DeleteData(index) {
    Swal.fire({
        title: '¿Estas Seguro?',
        text: "Recuerda que no podras deshacer esto!!!",
        icon: 'info',
